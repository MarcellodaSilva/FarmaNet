...
public class Farmacia implements Serializable {
    ...
    public void atualizarDados(Farmacia farmacia) {
		if(farmacia == null) return;
		
		if(farmacia.getCnpj() != null) {
			this.setCnpj(farmacia.getCnpj());
		}
		
		if(farmacia.getNome() != null) {
			this.setNome(farmacia.getNome());
		}
		
		if(farmacia.getLogin() != null) {
			this.setLogin(farmacia.getLogin());
		}
		
		if(farmacia.getSenha() != null) {
			this.setSenha(farmacia.getSenha());
		}
		
		if(farmacia.getTelefone01() != null) {
			this.setTelefone01(farmacia.getTelefone01());
		}
	}
}
